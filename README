...
Introduction
------------
The Guanxi Service Provider Engine module is the central
SAML engine as used by the Guanxi Service Provider Guard module
...
git clone http://github.com/guanxi/guanxi-sp-engine.git
cd guanxi-sp-engine
mvn clean install
